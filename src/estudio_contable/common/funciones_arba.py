...
def arba_descargar_deducciones(user, password, año, mes, carpeta_descargas=None):
    ...
    time.sleep(1)
    WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.CLASS_NAME, "camposFormulario")))
    ...
    driver.find_element(By.NAME, "Consultar").click()
